...
"bitmain-close-asic-boost" : false,
"bitmain-economic-mode" : false,
...
function f_get_miner_conf() {
    try
    {
        ...
        if(ant_data["bitmain-close-asic-boost"]) {
            document.getElementById("ant_multi_version").checked = false;
        } else {
            document.getElementById("ant_multi_version").checked = true;
        }
        if(ant_data["bitmain-economic-mode"]) {
            document.getElementById("ant_economic_mode").checked = true;
        } else {
            document.getElementById("ant_economic_mode").checked = false;
        }
...
function f_submit_miner_conf() {
    ...
    if(document.getElementById("ant_multi_version").checked) {
        _ant_asic_boost= "false";
    } else {
        _ant_asic_boost= "true";
    }

    if(document.getElementById("ant_economic_mode").checked) {
        _ant_economic_mode= "true";
    } else {
            ...
            <div class="cbi-map" id="cbi-bmminer">
                ...
                <fieldset class="cbi-section" id="cbi-bmminer-bmminer">
                    ...
                    <fieldset class="cbi-section" id="cbi-bmminer-default">
                        ...
                        <div class="cbi-value" id="asicboost">
                            <label class="cbi-value-title" for="keep">Low Power Mode</label>
                            <div class="cbi-value-field">
                                <input type="checkbox" name="ant_multi_version" id="ant_multi_version" />
                            </div>
                        </div>
                        <div class="cbi-value" id="economic" style="display:none">
                            <label class="cbi-value-title" for="keep">Economic Mode</label>
                            <div class="cbi-value-field">
                                <input type="checkbox" name="ant_economic_mode" id="ant_economic_mode" />
                        </div>
                        </div>
                    </fieldset>
                    <br />
